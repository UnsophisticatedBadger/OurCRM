# US-050 — Create a New Transaction
...
- US-006 — Log In and Out (session factory registered in DI)
- US-010 — Navigate Between Sections
- US-016 — Create a New Contact (contact model used for buyer/seller linking)
- US-043 — Create a New Property Listing (property model used for property linking)
