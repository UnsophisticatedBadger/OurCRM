...
As a real estate agent, I want to configure my HAR MLS credentials in OurCRM so that the app can connect to the Houston Association of REALTORS® MLS via the RESO Web API on my behalf.
