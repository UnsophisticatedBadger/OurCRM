# US-101 — Import Contacts from vCard
...
- US-100 — Handle Duplicate Contacts During Import
...
Duplicate detection is handled by the logic defined in US-100 (email match is the primary key, phone match is secondary).
...
6. Contacts that match an existing contact's email or phone are routed through the duplicate resolution step defined in US-100
...
**Story:** [US-101 — Import Contacts from vCard](../docs/085-import-contacts-from-vcard.md)
...
### Duplicate contacts are handled via US-100
