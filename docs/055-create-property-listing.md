# US-055 — Create a New Property Listing
...
- US-016 — Create a New Contact (contact model used for seller linking)
...
**Story:** [US-043 — Create a New Property Listing](../docs/043-create-property-listing.md)
