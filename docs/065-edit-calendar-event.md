...
- US-060 — Create a Calendar Event
...
3. All fields can be changed; the same validation rules apply as in US-060 (end time before start time is rejected with a validation error)
...
**Story:** [US-065 — Edit Calendar Event](../docs/065-edit-calendar-event.md)
