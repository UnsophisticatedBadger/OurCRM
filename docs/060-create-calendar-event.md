...
- US-006 — Log In with Master Password *(SQLAlchemy session factory must be in DI container before events can be persisted)*
- US-059 — View Calendar *(events must be visible after creation)*
